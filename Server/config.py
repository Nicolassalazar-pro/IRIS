{
    "MONGODB_URI": "mongodb+srv://DB_Access:BussThatShitDown@profiles.4ko8v.mongodb.net/?retryWrites=true&w=majority&appName=Profiles",
    "UI_URL":"https://10.53.1.209:6969/upload-audio",

    "PROFILE_DIR" : "../Profile_Images",
    "CACHE_DIR" : "../Cache",
    "CONFIG_DIR" : "A:\IRIS\V3\config.py",
